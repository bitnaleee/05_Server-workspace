...
public class RequestGetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 *  첫번째 매개변수인 request에는 요청과 관련된 내용들 담겨있음 (요청전송방식, 요청자의 ip주소, 요청시 전달된값들 등등)
		...
		String name = request.getParameter("name"); // "김해린" | ""
		...
		*/
		...
		// 즉, 여기 "Java코드 내에서" 사용자가 보게 될 응답 "html 구문을 작성"할꺼
		...
		// 1) 이제부터 내가 출력할 내용은 문서형태의 html이고 문자셋은 utf-8이다라는걸 선언
